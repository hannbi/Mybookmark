...
export default function MyLibrary() {
  ...
  const myBooks = [
    {
      ...
      title: "트렌드 코리아 2026",
      author: "김난도 외",
      cover: "https://image.aladin.co.kr/product/34470/7/cover500/k062939409_1.jpg",
      status: "done", // want, reading, done
    ...
    },
    {
      ...
      title: "스토너",
      author: "존 윌리엄스",
      cover: "https://image.aladin.co.kr/product/3389/40/cover500/8954635148_1.jpg",
      status: "reading",
    ...
    },
    {
      ...
      title: "달러구트 꿈 백화점",
      author: "이미예",
      cover: "https://image.aladin.co.kr/product/24485/92/cover500/k202631244_1.jpg",
      status: "done",
    ...
    },
    {
      ...
      title: "미드나잇 라이브러리",
      author: "매트 헤이그",
      cover: "https://image.aladin.co.kr/product/26949/90/cover500/k362730669_1.jpg",
      status: "want",
      addedDate: "2024-12-12"
    },
    {
      id: 5,
      title: "존재의 무게를 말하는 문장들",
      author: "김연수",
      cover: "https://image.aladin.co.kr/product/30581/35/cover500/k532830523_1.jpg",
      status: "reading",
    ...
    },
    {
      ...
      title: "문장의 온도",
      author: "이기주",
      cover: "https://image.aladin.co.kr/product/11738/61/cover500/k912535738_1.jpg",
      status: "done",
  ...
  const getFilteredBooks = () => {
    ...
    if (sortBy === "recent") {
      filtered = [...filtered].sort((a, b) => 
        new Date(b.addedDate) - new Date(a.addDate)
      );
  ...
  const currentMonthDone = myBooks.filter(b => 
    b.status === "done" && 
    new Date(b.addedDate).getMonth() === new Date().getMonth()
  ).length;
